...
function device_id_regex() {
    // validates register device_id form input
    var device_id = document.getElementById("register_device_id").value
    let dID_regex = /^cyber-arena-\d\d\d\d$/i;
    return dID_regex.test(device_id);
}
