...
if ($confirmation -eq 'y') {
    ...
    gcloud beta runtime-config configs variables set "teacher_instructions_url" https://storage.cloud.google.com/teacher_workout_instructions_"$project"/ --config-name "cybergym"
    gcloud beta runtime-config configs variables set "student_workout_instructions_url" https://storage.cloud.google.com/student_workout_instructions_"$project"/ --config-name "cybergym"
