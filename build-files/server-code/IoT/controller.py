...
class SenseHatControls(object):
    ...
    def __init__(self, init_time, sys_info, **kwargs):
        ...
        self.accel_crit_msg = 'CyberArena{eVRwYtFNdRVIVlfC}'
        self.brake = -10
        # unlock data
        self.combination = ['.....','--...','..---','-----']
        ...
        # misc data
        self.curious = 'CyberArena{DrjaGZ1NhkhoOMJr}'
        self.curious2 = 'CyberArena{SocialUnsecurityNumbers}'
    ...
    def display_accel(self):
        ...
        self.sense_hat.clear(Colors['RED'])
        sleep(1)
        self.sense_hat.clear(Colors['YELLOW'])
        sleep(1)
        self.sense_hat.clear(Colors['GREEN'])
        sleep(1)
        self.sense_hat.show_message(str(self._accel), text_colour=Colors['BLUE'], scroll_speed=0.02)
    ...
    def accel_critical(self):
        ...
        for i in range(3):
            ...
            sleep(.5)
            self.sense_hat.show_message('DANGER!', text_colour=Colors['RED'], scroll_speed=.03)
    ...
    def display_color(self, color):
        color = color.upper()
        if color in Colors:
            self.sense_hat.clear(Colors[color])
            if color == 'GREEN':
                return self.curious
            return color
    ...
    def display_temp(self):
        self.sense_hat.show_message(str(self._temp), text_colour=Colors['BLUE'], scroll_speed=0.2)
    ...
    def display_humidity(self):
        self.sense_hat.show_message(str(self._humidity), text_colour=Colors['GREEN'], scroll_speed=0.2)
    ...
    def display_pressure(self):
        self.sense_hat.show_message(str(self._pressure), text_colour=Colors['RED'], scroll_speed=0.2)
        logging.info('Success')
