...
class ColTransposition(object):
    def __init__(self, message=None, keyword=None):
        """
        ...
        Note:
            ...
            change the outcome of message encryption or decryption
                ...
                All keywords will be converted to upper and all spaces
    ...
    @staticmethod
    def getEncipherKeywordSequence(keyword):
        '''
    ...
    @staticmethod
    def getDecipherKeywordSequence(keyword):
        """
        :param keyword:
    ...
    @staticmethod
    def remove_punctuation(message, filter='[^a-zA-Z0-9_=]'):
        """
