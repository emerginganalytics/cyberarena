...
from JohnnyArena.routes import arena
from JohnnyCipher.utils import CaesarCipherBuilder, SubstitutionCipherBuilder
from JohnnyCipher.routes import johnnycipher
from GenCyber1.routes import johnnyGenCipher
...
app.register_blueprint(johnnycipher)
app.register_blueprint(johnnyGenCipher)
